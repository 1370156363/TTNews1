...
- (void)viewDidLoad {
    ...
    self.segmented.selectionIndicatorHeight = 0;
...
- (void)segmentedControlChangedValue:(UISegmentedControl *)segment {
    ...
    self.MLBasePageViewBlock(index);
    ...
    if (!_pageVC) {
        ...
        _pageVC = [[UIPageViewController alloc] initWithTransitionStyle:UIPageViewControllerTransitionStyleScroll
                                                  navigationOrientation:UIPageViewControllerNavigationOrientationHorizontal
                                                                options:options];
        _pageVC.view.frame = CGRectMake(0, 64+44, kScreenWidth, kScreenHeight-64-44);
...
- (HMSegmentedControl *)segmented {
    if (!_segmented) {
        ...
        _segmented.frame = CGRectMake(0, 64, kScreenWidth, 44);
