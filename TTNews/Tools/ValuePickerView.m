...
- (void)initSubViews
{
    ...
    self.finishBtn.titleLabel.font = [UIFont fontWithName:@"STHeitiTC-Light" size:17];
    ...
    self.cancelBtn.titleLabel.font = [UIFont fontWithName:@"STHeitiTC-Light" size:17];
    ...
    self.titleLabel.font=[UIFont fontWithName:@"STHeitiTC-Light" size:17];
...
- (void)layoutSelfSubviews
{
    ...
    //完成按钮
    self.finishBtn.frame = CGRectMake(SCREEN_WIDTH - 70, 0, 70, 40);
    
    //取消按钮
    self.cancelBtn.frame = CGRectMake(0, 0, 70, 40);
    
    //标题
    self.titleLabel.frame = CGRectMake(70, 0, SCREEN_WIDTH - 140, 40);
}
