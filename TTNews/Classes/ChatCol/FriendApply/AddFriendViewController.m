...
- (void)viewDidLoad
{
    ...
    [searchButton setTitleColor:[UIColor colorWithRed:255 / 255.0 green:255 / 255.0 blue:255 / 255.0 alpha:1.0] forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.headView.image = [UIImage imageNamed:@"chatListCellHead.png"];
    cell.contentLab.text = [self.dataSource objectAtIndex:indexPath.row];
